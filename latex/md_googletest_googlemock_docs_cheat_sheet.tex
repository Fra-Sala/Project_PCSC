\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md12}{}\doxysection{Defining a Mock Class}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md12}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_MockClass}{}\doxysubsection{Mocking a Normal Class}\label{md_googletest_googlemock_docs_cheat_sheet_MockClass}
Given
...
{\bfseries{Note\+:}} A mock object is currently naggy by default. We may make it nice by default in the future.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_MockTemplate}{}\doxysubsection{Mocking a Class Template}\label{md_googletest_googlemock_docs_cheat_sheet_MockTemplate}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md13}{}\doxysubsection{Specifying Calling Conventions for Mock Functions}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md13}
...
where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily $<$objbase.\+h$>$} on Windows.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_UsingMocks}{}\doxysection{Using Mocks in Tests}\label{md_googletest_googlemock_docs_cheat_sheet_UsingMocks}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_OnCall}{}\doxysection{Setting Default Actions}\label{md_googletest_googlemock_docs_cheat_sheet_OnCall}
...
To customize the default action for a particular method of a specific mock object, use {\ttfamily ON\+\_\+\+CALL()}. {\ttfamily ON\+\_\+\+CALL()} has a similar syntax to {\ttfamily EXPECT\+\_\+\+CALL()}, but it is used for setting default behaviors (when you do not require that the mock method is called). See \href{cook_book.md\#UseOnCall}{\texttt{ here}} for a more detailed discussion.
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_ExpectCall}{}\doxysection{Setting Expectations}\label{md_googletest_googlemock_docs_cheat_sheet_ExpectCall}
{\ttfamily EXPECT\+\_\+\+CALL()} sets {\bfseries{expectations}} on a mock method (How will it be called? What will it do?)\+:
...
In order to pass, {\ttfamily EXPECT\+\_\+\+CALL} must be used before the calls are actually made.
...
A method with no {\ttfamily EXPECT\+\_\+\+CALL()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_MatcherList}{}\doxysection{Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_MatcherList}
...
{\bfseries{Note\+:}} Although equality matching via {\ttfamily EXPECT\+\_\+\+THAT(actual\+\_\+value, expected\+\_\+value)} is supported, prefer to make the comparison explicit via {\ttfamily EXPECT\+\_\+\+THAT(actual\+\_\+value, Eq(expected\+\_\+value))} or {\ttfamily EXPECT\+\_\+\+EQ(actual\+\_\+value, expected\+\_\+value)}.

Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}, the arguments of {\ttfamily method}) are divided into several categories\+:\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md14}{}\doxysubsection{Wildcard}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md14}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md15}{}\doxysubsection{Generic Comparison}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md15}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{../../googletest/docs/primer\#basic-assertions}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_FpMatchers}{}\doxysubsection{Floating-\/\+Point Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md16}{}\doxysubsection{String Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md16}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../../googletest/docs/advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md17}{}\doxysubsection{Container Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md17}
...
\`{}\`{}\`{}cpp using \+::std\+::get; MATCHER(Foo\+Eq, \char`\"{}\char`\"{}) \{ return std\+::get$<$0$>$(arg).Equals(std\+::get$<$1$>$(arg)); \} ... EXPECT\+\_\+\+THAT(actual\+\_\+foos, Pointwise(\+Foo\+Eq(), expected\+\_\+foos)); \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md18}{}\doxysubsection{Member Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md18}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md19}{}\doxysubsection{Matching the Result of a Function, Functor, or Callback}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md19}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md20}{}\doxysubsection{Pointer Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md20}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_MultiArgMatchers}{}\doxysubsection{Multi-\/argument Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_MultiArgMatchers}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md21}{}\doxysubsection{Composite Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md21}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md22}{}\doxysubsection{Adapters for Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md22}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_MatchersAsPredicatesCheat}{}\doxysubsection{Using Matchers as Predicates}\label{md_googletest_googlemock_docs_cheat_sheet_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md23}{}\doxysubsection{Defining Matchers}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md23}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{DoxyEnumerate}\hypertarget{md_googletest_googlemock_docs_cheat_sheet_ActionList}{}\doxysection{Actions}\label{md_googletest_googlemock_docs_cheat_sheet_ActionList}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md24}{}\doxysubsection{Returning a Value}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md24}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md25}{}\doxysubsection{Side Effects}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md25}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ }&\cellcolor{\tableheadbgcolor}\textbf{ }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md26}{}\doxysubsection{Using a Function, Functor, or Lambda as an Action}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md26}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md27}{}\doxysubsection{Default Action}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md27}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md28}{}\doxysubsection{Composite Actions}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md28}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ }&\cellcolor{\tableheadbgcolor}\textbf{ }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md29}{}\doxysubsection{Defining Actions}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md29}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ }&\cellcolor{\tableheadbgcolor}\textbf{ }\\\cline{1-2}
...
The {\ttfamily ACTION$\ast$} macros cannot be used inside a function or class.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_CardinalityList}{}\doxysection{Cardinalities}\label{md_googletest_googlemock_docs_cheat_sheet_CardinalityList}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md30}{}\doxysection{Expectation Order}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md30}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_AfterClause}{}\doxysubsection{The After Clause}\label{md_googletest_googlemock_docs_cheat_sheet_AfterClause}
...
Modifying an {\ttfamily Expectation\+Set} after using it in an {\ttfamily .After()} doesn\textquotesingle{}t affect the meaning of the {\ttfamily .After()}.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_UsingSequences}{}\doxysubsection{Sequences}\label{md_googletest_googlemock_docs_cheat_sheet_UsingSequences}
...
says that all expected calls in the scope of {\ttfamily seq} must occur in strict order. The name {\ttfamily seq} is irrelevant.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md31}{}\doxysection{Verifying and Resetting a Mock}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md31}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md32}{}\doxysection{Mock Classes}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md32}
...
See this \href{cook_book.md\#using-check-points}{\texttt{ recipe}} for one application of it.\hypertarget{md_googletest_googlemock_docs_cheat_sheet_autotoc_md33}{}\doxysection{Flags}\label{md_googletest_googlemock_docs_cheat_sheet_autotoc_md33}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
