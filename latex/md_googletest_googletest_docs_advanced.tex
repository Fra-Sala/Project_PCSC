\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md145}{}\doxysection{Introduction}\label{md_googletest_googletest_docs_advanced_autotoc_md145}
Now that you have read the \mbox{\hyperlink{md_googletest_googletest_docs_primer}{googletest Primer}} and learned how to write tests using googletest, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md146}{}\doxysection{More Assertions}\label{md_googletest_googletest_docs_advanced_autotoc_md146}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md147}{}\doxysubsection{Explicit Success and Failure}\label{md_googletest_googletest_docs_advanced_autotoc_md147}
...
Generates a success. This does {\bfseries{NOT}} make the overall test succeed. A test is considered successful only if none of its assertions fail during its execution.

NOTE\+: {\ttfamily SUCCEED()} is purely documentary and currently doesn\textquotesingle{}t generate any user-\/visible output. However, we may add {\ttfamily SUCCEED()} messages to googletest\textquotesingle{}s output in the future.
...
{\ttfamily FAIL()} generates a fatal failure, while {\ttfamily ADD\+\_\+\+FAILURE()} and {\ttfamily ADD\+\_\+\+FAILURE\+\_\+\+AT()} generate a nonfatal failure. These are useful when control flow, rather than a Boolean expression, determines the test\textquotesingle{}s success or failure. For example, you might want to write something like\+:
...
NOTE\+: you can only use {\ttfamily FAIL()} in functions that return {\ttfamily void}. See the \href{\#assertion-placement}{\texttt{ Assertion Placement section}} for more information.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md148}{}\doxysubsection{Exception Assertions}\label{md_googletest_googletest_docs_advanced_autotoc_md148}
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+THROW(statement, exception\+\_\+type);}   &{\ttfamily EXPECT\+\_\+\+THROW(statement, exception\+\_\+type);}   &{\ttfamily statement} throws an exception of the given type    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+ANY\+\_\+\+THROW(statement);}   &{\ttfamily EXPECT\+\_\+\+ANY\+\_\+\+THROW(statement);}   &{\ttfamily statement} throws an exception of any type    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+NO\+\_\+\+THROW(statement);}   &{\ttfamily EXPECT\+\_\+\+NO\+\_\+\+THROW(statement);}   &{\ttfamily statement} doesn\textquotesingle{}t throw any exception   \\\cline{1-3}
\end{longtabu}
...
{\bfseries{Availability}}\+: requires exceptions to be enabled in the build environment\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md149}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_googletest_googletest_docs_advanced_autotoc_md149}
...
googletest gives you three different options to solve this problem\+:\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md150}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_googletest_googletest_docs_advanced_autotoc_md150}
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+PRED1(pred1, val1)}   &{\ttfamily EXPECT\+\_\+\+PRED1(pred1, val1)}   &{\ttfamily pred1(val1)} is true    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+PRED2(pred2, val1, val2)}   &{\ttfamily EXPECT\+\_\+\+PRED2(pred2, val1, val2)}   &{\ttfamily pred2(val1, val2)} is true    \\\cline{1-3}
...
\begin{DoxyEnumerate}
\item If you see a compiler error \char`\"{}no matching function to call\char`\"{} when using {\ttfamily ASSERT\+\_\+\+PRED$\ast$} or {\ttfamily EXPECT\+\_\+\+PRED$\ast$}, please see \href{faq.md\#the-compiler-complains-no-matching-function-to-call-when-i-use-assert-pred-how-do-i-fix-it}{\texttt{ this}} for how to resolve it. 
\end{DoxyEnumerate}\end{quote}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md151}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_googletest_googletest_docs_advanced_autotoc_md151}
...
\end{DoxyCode}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md152}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_googletest_googletest_docs_advanced_autotoc_md152}
If you find the default message generated by {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+PRED$\ast$} and {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+(TRUE$\vert$\+FALSE)} unsatisfactory, or some arguments to your predicate do not support streaming to {\ttfamily ostream}, you can instead use the following {\itshape predicate-\/formatter assertions} to {\itshape fully} customize how the message is formatted\+:
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+PRED\+\_\+\+FORMAT1(pred\+\_\+format1, val1);}   &{\ttfamily EXPECT\+\_\+\+PRED\+\_\+\+FORMAT1(pred\+\_\+format1, val1);}   &{\ttfamily pred\+\_\+format1(val1)} is successful    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+PRED\+\_\+\+FORMAT2(pred\+\_\+format2, val1, val2);}   &{\ttfamily EXPECT\+\_\+\+PRED\+\_\+\+FORMAT2(pred\+\_\+format2, val1, val2);}   &{\ttfamily pred\+\_\+format2(val1, val2)} is successful    \\\cline{1-3}
{\ttfamily ...}   &{\ttfamily ...}   &...   \\\cline{1-3}
\end{longtabu}


The difference between this and the previous group of macros is that instead of a predicate, {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+PRED\+\_\+\+FORMAT$\ast$} take a {\itshape predicate-\/formatter} ({\ttfamily pred\+\_\+formatn}), which is a function or functor with the signature\+:
...
As an example, let\textquotesingle{}s improve the failure message in {\ttfamily Mutually\+Prime()}, which was used with {\ttfamily EXPECT\+\_\+\+PRED2()}\+:
...
As you may have realized, many of the built-\/in assertions we introduced earlier are special cases of {\ttfamily (EXPECT$\vert$\+ASSERT)\+\_\+\+PRED\+\_\+\+FORMAT$\ast$}. In fact, most of them are indeed defined using {\ttfamily (EXPECT$\vert$\+ASSERT)\+\_\+\+PRED\+\_\+\+FORMAT$\ast$}.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md153}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_googletest_googletest_docs_advanced_autotoc_md153}
...
In general, for floating-\/point comparison to make sense, the user needs to carefully choose the error bound. If they don\textquotesingle{}t want or care to, comparing in terms of Units in the Last Place (ULPs) is a good default, and googletest provides assertions to do this. Full details about ULPs are quite long; if you want to learn more, see \href{https://randomascii.wordpress.com/2012/02/25/comparing-floating-point-numbers-2012-edition/}{\texttt{ here}}.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md154}{}\doxysubsubsection{Floating-\/\+Point Macros}\label{md_googletest_googletest_docs_advanced_autotoc_md154}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+FLOAT\+\_\+\+EQ(val1, val2);}   &{\ttfamily EXPECT\+\_\+\+FLOAT\+\_\+\+EQ(val1, val2);}   &the two {\ttfamily float} values are almost equal    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+DOUBLE\+\_\+\+EQ(val1, val2);}   &{\ttfamily EXPECT\+\_\+\+DOUBLE\+\_\+\+EQ(val1, val2);}   &the two {\ttfamily double} values are almost equal   \\\cline{1-3}
\end{longtabu}


By \char`\"{}almost equal\char`\"{} we mean the values are within 4 ULP\textquotesingle{}s from each other.
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+NEAR(val1, val2, abs\+\_\+error);}   &{\ttfamily EXPECT\+\_\+\+NEAR(val1, val2, abs\+\_\+error);}   &the difference between {\ttfamily val1} and {\ttfamily val2} doesn\textquotesingle{}t exceed the given absolute error   \\\cline{1-3}
\end{longtabu}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md155}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_googletest_googletest_docs_advanced_autotoc_md155}
...
Verifies that {\ttfamily val1} is less than, or almost equal to, {\ttfamily val2}. You can replace {\ttfamily EXPECT\+\_\+\+PRED\+\_\+\+FORMAT2} in the above table with {\ttfamily ASSERT\+\_\+\+PRED\+\_\+\+FORMAT2}.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md156}{}\doxysubsection{Asserting Using g\+Mock Matchers}\label{md_googletest_googletest_docs_advanced_autotoc_md156}
\href{../../googlemock}{\texttt{ g\+Mock}} comes with \href{../../googlemock/docs/cheat_sheet.md\#MatcherList}{\texttt{ a library of matchers}} for validating arguments passed to mock objects. A g\+Mock {\itshape matcher} is basically a predicate that knows how to describe itself. It can be used in these assertion macros\+:
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+THAT(value, matcher);}   &{\ttfamily EXPECT\+\_\+\+THAT(value, matcher);}   &value matches matcher   \\\cline{1-3}
\end{longtabu}
...
g\+Mock is bundled with googletest, so you don\textquotesingle{}t need to add any build dependency in order to take advantage of this. Just include {\ttfamily \char`\"{}gmock/gmock.\+h\char`\"{}} and you\textquotesingle{}re ready to go.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md157}{}\doxysubsection{More String Assertions}\label{md_googletest_googletest_docs_advanced_autotoc_md157}
(Please read the \href{\#asserting-using-gmock-matchers}{\texttt{ previous}} section first if you haven\textquotesingle{}t.)

You can use the g\+Mock \href{../../googlemock/docs/cheat_sheet.md\#string-matchers}{\texttt{ string matchers}} with {\ttfamily EXPECT\+\_\+\+THAT()} or {\ttfamily ASSERT\+\_\+\+THAT()} to do more string comparison tricks (sub-\/string, prefix, suffix, regular expression, and etc). For example,
...
If the string contains a well-\/formed HTML or XML document, you can check whether its DOM tree matches an \href{http://www.w3.org/TR/xpath/\#contents}{\texttt{ XPath expression}}\+:
...
\end{DoxyCode}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md158}{}\doxysubsection{Windows HRESULT assertions}\label{md_googletest_googletest_docs_advanced_autotoc_md158}
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+HRESULT\+\_\+\+SUCCEEDED(expression)}   &{\ttfamily EXPECT\+\_\+\+HRESULT\+\_\+\+SUCCEEDED(expression)}   &{\ttfamily expression} is a success {\ttfamily HRESULT}    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+HRESULT\+\_\+\+FAILED(expression)}   &{\ttfamily EXPECT\+\_\+\+HRESULT\+\_\+\+FAILED(expression)}   &{\ttfamily expression} is a failure {\ttfamily HRESULT}   \\\cline{1-3}
\end{longtabu}


The generated output contains the human-\/readable error message associated with the {\ttfamily HRESULT} code returned by {\ttfamily expression}.
...
\end{DoxyCode}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md159}{}\doxysubsection{Type Assertions}\label{md_googletest_googletest_docs_advanced_autotoc_md159}
...
to cause a compiler error.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md160}{}\doxysubsection{Assertion Placement}\label{md_googletest_googletest_docs_advanced_autotoc_md160}
...
WARNING\+: A fatal assertion in a helper function (private void-\/returning method) called from a constructor or destructor does not terminate the current test, as your intuition might suggest\+: it merely returns from the constructor or destructor early, possibly leaving your object in a partially-\/constructed or partially-\/destructed state! You almost certainly want to {\ttfamily abort} or use {\ttfamily Set\+Up}/{\ttfamily Tear\+Down} instead.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md161}{}\doxysection{Teaching googletest How to Print Your Values}\label{md_googletest_googletest_docs_advanced_autotoc_md161}
...
\end{DoxyCode}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md162}{}\doxysection{Death Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md162}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see Catching Failures\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md163}{}\doxysubsection{How to Write a Death Test}\label{md_googletest_googletest_docs_advanced_autotoc_md163}
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
\endhead
{\ttfamily ASSERT\+\_\+\+DEATH(statement, matcher);}   &{\ttfamily EXPECT\+\_\+\+DEATH(statement, matcher);}   &{\ttfamily statement} crashes with the given error    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED(statement, matcher);}   &{\ttfamily EXPECT\+\_\+\+DEATH\+\_\+\+IF\+\_\+\+SUPPORTED(statement, matcher);}   &if death tests are supported, verifies that {\ttfamily statement} crashes with the given error; otherwise verifies nothing    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+DEBUG\+\_\+\+DEATH(statement, matcher);}   &{\ttfamily EXPECT\+\_\+\+DEBUG\+\_\+\+DEATH(statement, matcher);}   &{\ttfamily statement} crashes with the given error {\bfseries{in debug mode}}. When not in debug (i.\+e. {\ttfamily NDEBUG} is defined), this just executes {\ttfamily statement}    \\\cline{1-3}
{\ttfamily ASSERT\+\_\+\+EXIT(statement, predicate, matcher);}   &{\ttfamily EXPECT\+\_\+\+EXIT(statement, predicate, matcher);}   &{\ttfamily statement} exits with the given error, and its exit code matches {\ttfamily predicate}   \\\cline{1-3}
\end{longtabu}
...
\begin{quote}
NOTE\+: We use the word \char`\"{}crash\char`\"{} here to mean that the process terminates with a {\itshape non-\/zero} exit status code. There are two possibilities\+: either the process has called {\ttfamily exit()} or {\ttfamily \+\_\+exit()} with a non-\/zero value, or it may be killed by a signal.

This means that if $\ast${\ttfamily statement}$\ast$ terminates the process with a 0 exit code, it is {\itshape not} considered a crash by {\ttfamily EXPECT\+\_\+\+DEATH}. Use {\ttfamily EXPECT\+\_\+\+EXIT} instead if this is the case, or if you want to restrict the exit code more precisely. \end{quote}
...
The {\ttfamily $\ast$\+\_\+\+DEATH} macros are convenient wrappers for {\ttfamily $\ast$\+\_\+\+EXIT} that use a predicate that verifies the process\textquotesingle{} exit code is non-\/zero.
...
In particular, if {\ttfamily statement} generates an {\ttfamily ASSERT\+\_\+$\ast$} or {\ttfamily EXPECT\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as googletest assertions don\textquotesingle{}t abort the process.
...
The test function body may contain other assertions and statements as well, if necessary.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md164}{}\doxysubsection{Death Test Naming}\label{md_googletest_googletest_docs_advanced_autotoc_md164}
IMPORTANT\+: We strongly recommend you to follow the convention of naming your {\bfseries{test suite}} (not test) {\ttfamily $\ast$\+Death\+Test} when it contains a death test, as demonstrated in the above example. The \href{\#death-tests-and-threads}{\texttt{ Death Tests And Threads}} section below explains why.
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md167}{}\doxysubsection{Death Tests And Threads}\label{md_googletest_googletest_docs_advanced_autotoc_md167}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md168}{}\doxysubsection{Death Test Styles}\label{md_googletest_googletest_docs_advanced_autotoc_md168}
...
\end{DoxyCode}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md169}{}\doxysubsection{Caveats}\label{md_googletest_googletest_docs_advanced_autotoc_md169}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md170}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_googletest_googletest_docs_advanced_autotoc_md170}
Note\+: If you want to put a series of test assertions in a subroutine to check for a complex condition, consider using \href{../../googlemock/docs/cook_book.md\#NewMatchers}{\texttt{ a custom GMock matcher}} instead. This lets you provide a more readable error message in case of failure and avoid all of the issues described below.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md171}{}\doxysubsection{Adding Traces to Assertions}\label{md_googletest_googletest_docs_advanced_autotoc_md171}
...
\end{DoxyEnumerate}\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md172}{}\doxysubsection{Propagating Fatal Failures}\label{md_googletest_googletest_docs_advanced_autotoc_md172}
...
To alleviate this, googletest provides three different solutions. You could use either exceptions, the {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+NO\+\_\+\+FATAL\+\_\+\+FAILURE} assertions or the {\ttfamily Has\+Fatal\+Failure()} function. They are described in the following two subsections.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md173}{}\doxysubsubsection{Asserting on Subroutines with an exception}\label{md_googletest_googletest_docs_advanced_autotoc_md173}
...
This listener should be added after other listeners if you have any, otherwise they won\textquotesingle{}t see failed {\ttfamily On\+Test\+Part\+Result}.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md174}{}\doxysubsubsection{Asserting on Subroutines}\label{md_googletest_googletest_docs_advanced_autotoc_md174}
...
Assertions from multiple threads are currently not supported on Windows.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md175}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_googletest_googletest_docs_advanced_autotoc_md175}
...
Similarly, {\ttfamily Has\+Nonfatal\+Failure()} returns {\ttfamily true} if the current test has at least one non-\/fatal failure, and {\ttfamily Has\+Failure()} returns {\ttfamily true} if the current test has at least one failure of either kind.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md176}{}\doxysection{Logging Additional Information}\label{md_googletest_googletest_docs_advanced_autotoc_md176}
...
\item $\ast${\ttfamily key}$\ast$ must be a valid XML attribute name, and cannot conflict with the ones already used by googletest ({\ttfamily name}, {\ttfamily status}, {\ttfamily time}, {\ttfamily classname}, {\ttfamily type\+\_\+param}, and {\ttfamily value\+\_\+param}).
...
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md177}{}\doxysection{Sharing Resources Between Tests in the Same Test Suite}\label{md_googletest_googletest_docs_advanced_autotoc_md177}
...
NOTE\+: Though the above code declares {\ttfamily Set\+Up\+Test\+Suite()} protected, it may sometimes be necessary to declare it public, such as when using it with {\ttfamily TEST\+\_\+P}.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md178}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_googletest_googletest_docs_advanced_autotoc_md178}
...
\end{DoxyItemize}\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md180}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md180}
...
NOTE\+: If your test fixture defines {\ttfamily Set\+Up\+Test\+Suite()} or {\ttfamily Tear\+Down\+Test\+Suite()} they must be declared {\bfseries{public}} rather than {\bfseries{protected}} in order to use {\ttfamily TEST\+\_\+P}.
...
Finally, you can use {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+SUITE\+\_\+P} to instantiate the test suite with any set of parameters you want. googletest defines a number of functions for generating test parameters. They return what we call (surprise!) {\itshape parameter generators}. Here is a summary of them, which are all in the {\ttfamily testing} namespace\+:
...
{\ttfamily Values\+In(container)} and {\ttfamily Values\+In(begin,end)}   &Yields values from a C-\/style array, an STL-\/style container, or an iterator range {\ttfamily \mbox{[}begin, end)}    \\\cline{1-2}
...
The following statement will instantiate tests from the {\ttfamily \mbox{\hyperlink{classFooTest}{Foo\+Test}}} test suite each with parameter values {\ttfamily \char`\"{}meeny\char`\"{}}, {\ttfamily \char`\"{}miny\char`\"{}}, and {\ttfamily \char`\"{}moe\char`\"{}}.
...
Per default, every {\ttfamily TEST\+\_\+P} without a corresponding {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+SUITE\+\_\+P} causes a failing test in test suite {\ttfamily Google\+Test\+Verification}. If you have a test suite where that omission is not an error, for example it is in a library that may be linked in for other reason or where the list of test cases is dynamic and may be empty, then this check can be suppressed by tagging the test suite\+:
...
You can see \href{../samples/sample7_unittest.cc}{\texttt{ sample7\+\_\+unittest.\+cc}} and \href{../samples/sample8_unittest.cc}{\texttt{ sample8\+\_\+unittest.\+cc}} for more examples.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md181}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md181}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily INSTANTIATE\+\_\+\+TEST\+\_\+\+SUITE\+\_\+\+P()}, and depending on the library target that contains {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test suite multiple times, possibly in different source files.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md182}{}\doxysubsection{Specifying Names for Value-\/\+Parameterized Test Parameters}\label{md_googletest_googletest_docs_advanced_autotoc_md182}
...
NOTE\+: test names must be non-\/empty, unique, and may only contain ASCII alphanumeric characters. In particular, they \href{faq.md\#why-should-test-suite-names-and-test-names-not-contain-underscore}{\texttt{ should not contain underscores}}
...
\end{DoxyCode}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md183}{}\doxysection{Typed Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md183}
...
You can see \href{../samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md184}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md184}
...
You can see \href{../samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md185}{}\doxysection{Testing Private Code}\label{md_googletest_googletest_docs_advanced_autotoc_md185}
...
\} // namespace my\+\_\+namespace \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md186}{}\doxysection{\char`\"{}\+Catching\char`\"{} Failures}\label{md_googletest_googletest_docs_advanced_autotoc_md186}
...
\end{DoxyEnumerate}\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md187}{}\doxysection{Registering tests programmatically}\label{md_googletest_googletest_docs_advanced_autotoc_md187}
...
\end{DoxyCode}
 \hypertarget{md_googletest_googletest_docs_advanced_autotoc_md188}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_googletest_googletest_docs_advanced_autotoc_md188}
...
{\ttfamily current\+\_\+test\+\_\+info()} returns a null pointer if no test is running. In particular, you cannot find the test suite name in {\ttfamily Set\+Up\+Test\+Suite()}, {\ttfamily Tear\+Down\+Test\+Suite()} (where you know the test suite name implicitly), or functions called from them.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md189}{}\doxysection{Extending googletest by Handling Test Events}\label{md_googletest_googletest_docs_advanced_autotoc_md189}
googletest provides an {\bfseries{event listener API}} to let you receive notifications about the progress of a test program and test failures. The events you can listen to include the start and end of the test program, a test suite, or a test method, among others. You may use this API to augment or replace the standard console output, replace the XML output, or provide a completely different form of output, such as a GUI or a database. You can also use test events as checkpoints to implement a resource leak checker, for example.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md190}{}\doxysubsection{Defining Event Listeners}\label{md_googletest_googletest_docs_advanced_autotoc_md190}
...
\end{DoxyCode}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md191}{}\doxysubsection{Using Event Listeners}\label{md_googletest_googletest_docs_advanced_autotoc_md191}
To use the event listener you have defined, add an instance of it to the googletest event listener list (represented by class Test\+Event\+Listeners -\/ note the \char`\"{}s\char`\"{} at the end of the name) in your {\ttfamily main()} function, before calling {\ttfamily RUN\+\_\+\+ALL\+\_\+\+TESTS()}\+:
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md192}{}\doxysubsection{Generating Failures in Listeners}\label{md_googletest_googletest_docs_advanced_autotoc_md192}
...
See \href{../samples/sample10_unittest.cc}{\texttt{ sample10\+\_\+unittest.\+cc}} for an example of a failure-\/raising listener.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md193}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_googletest_googletest_docs_advanced_autotoc_md193}
...
If an option is specified both by an environment variable and by a flag, the latter takes precedence.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md194}{}\doxysubsection{Selecting Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md194}
\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md195}{}\doxysubsubsection{Listing Test Names}\label{md_googletest_googletest_docs_advanced_autotoc_md195}
...
None of the tests listed are actually run if the flag is provided. There is no corresponding environment variable for this flag.\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md196}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md196}
...
{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md197}{}\doxysubsubsection{Stop test execution upon first failure}\label{md_googletest_googletest_docs_advanced_autotoc_md197}
...
{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md198}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md198}
...
{\itshape NOTE\+: This feature should only be used for temporary pain-\/relief. You still have to fix the disabled tests at a later date. As a reminder, googletest will print a banner warning you if a test program contains any disabled tests.}

{\itshape TIP\+: You can easily count the number of disabled tests you have using {\ttfamily gsearch} and/or {\ttfamily grep}. This number can be used as a metric for improving your test quality.}

{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md199}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md199}
...
{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md200}{}\doxysubsection{Repeating the Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md200}
...
{\itshape If your test program contains \href{\#global-set-up-and-tear-down}{\texttt{ global set-\/up/tear-\/down}} code, it will be repeated in each iteration as well, as the flakiness may be in it. You can also specify the repeat count by setting the {\ttfamily GTEST\+\_\+\+REPEAT} environment variable.}

{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md201}{}\doxysubsection{Shuffling the Tests}\label{md_googletest_googletest_docs_advanced_autotoc_md201}
...
{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md202}{}\doxysubsection{Controlling Test Output}\label{md_googletest_googletest_docs_advanced_autotoc_md202}
{\itshape  }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md203}{}\doxysubsubsection{Colored Terminal Output}\label{md_googletest_googletest_docs_advanced_autotoc_md203}
{\itshape  googletest can use colors in its terminal output to make it easier to spot the important information\+:}

{\itshape {\ttfamily  ...~\newline
 $<$font color=\char`\"{}green\char`\"{}$>$\mbox{[}-\/-\/-\/-\/-\/-\/-\/---\mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ 1 test from \mbox{\hyperlink{classFooTest}{Foo\+Test}}$<$/font$>$~\newline
 $<$font color=\char`\"{}green\char`\"{}$>$\mbox{[} RUN ~ ~ ~\mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ Foo\+Test.\+Does\+Abc$<$/font$>$~\newline
 ...
 $<$font color=\char`\"{}green\char`\"{}$>$\mbox{[} RUN ~ ~ ~\mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ Bar\+Test.\+Has\+Xyz\+Property $<$/font$>$~\newline
 $<$font color=\char`\"{}green\char`\"{}$>$\mbox{[} ~ ~ ~ OK \mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ Bar\+Test.\+Has\+Xyz\+Property$<$/font$>$~\newline
 $<$font color=\char`\"{}green\char`\"{}$>$\mbox{[} RUN ~ ~ ~\mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ Bar\+Test.\+Returns\+True\+On\+Success ... some error messages ...$<$/font$>$~\newline
 $<$font color=\char`\"{}red\char`\"{}$>$\mbox{[} ~ FAILED \mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ Bar\+Test.\+Returns\+True\+On\+Success ...$<$/font$>$~\newline
 $<$font color=\char`\"{}green\char`\"{}$>$\mbox{[}==========\mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ 30 tests from 14 test suites ran.$<$/font$>$~\newline
 $<$font color=\char`\"{}green\char`\"{}$>$\mbox{[} ~ PASSED \mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ 28 tests.$<$/font$>$~\newline
 $<$font color=\char`\"{}red\char`\"{}$>$\mbox{[} ~ FAILED \mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ 2 tests, listed below\+:$<$/font$>$~\newline
 $<$font color=\char`\"{}red\char`\"{}$>$\mbox{[} ~ FAILED \mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ Bar\+Test.\+Returns\+True\+On\+Success$<$/font$>$~\newline
 $<$font color=\char`\"{}red\char`\"{}$>$\mbox{[} ~ FAILED \mbox{]}$<$/font$>$$<$font color=\char`\"{}black\char`\"{}$>$ Another\+Test.\+Does\+Xyz~\newline
 ~\newline
 2 FAILED TESTS $<$/font$>$ }}
...
{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md204}{}\doxysubsubsection{Suppressing test passes}\label{md_googletest_googletest_docs_advanced_autotoc_md204}
{\itshape  By default, googletest prints 1 line of output for each test, indicating if it passed or failed. To show only test failures, run the test program with {\ttfamily -\/-\/gtest\+\_\+brief=1}, or set the GTEST\+\_\+\+BRIEF environment variable to {\ttfamily 1}.}

{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md205}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_googletest_googletest_docs_advanced_autotoc_md205}
{\itshape  By default, googletest prints the time it takes to run each test. To disable that, run the test program with the {\ttfamily -\/-\/gtest\+\_\+print\+\_\+time=0} command line flag, or set the GTEST\+\_\+\+PRINT\+\_\+\+TIME environment variable to {\ttfamily 0}.}

{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md206}{}\doxysubsubsection{Suppressing UTF-\/8 Text Output}\label{md_googletest_googletest_docs_advanced_autotoc_md206}
{\itshape  In case of assertion failures, googletest prints expected and actual values of type {\ttfamily string} both as hex-\/encoded strings as well as in readable UTF-\/8 text if they contain valid non-\/\+ASCII UTF-\/8 characters. If you want to suppress the UTF-\/8 text because, for example, you don\textquotesingle{}t have an UTF-\/8 compatible output medium, run the test program with {\ttfamily -\/-\/gtest\+\_\+print\+\_\+utf8=0} or set the {\ttfamily GTEST\+\_\+\+PRINT\+\_\+\+UTF8} environment variable to {\ttfamily 0}.}

{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md207}{}\doxysubsubsection{Generating an XML Report}\label{md_googletest_googletest_docs_advanced_autotoc_md207}
{\itshape  googletest can emit a detailed XML report to a file in addition to its normal textual output. The report contains the duration of each test, and thus can help you identify slow tests.}
...
{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md208}{}\doxysubsubsection{Generating a JSON Report}\label{md_googletest_googletest_docs_advanced_autotoc_md208}
{\itshape  googletest can also emit a JSON report as an alternative format to XML. To generate the JSON report, set the {\ttfamily GTEST\+\_\+\+OUTPUT} environment variable or the {\ttfamily -\/-\/gtest\+\_\+output} flag to the string {\ttfamily \char`\"{}json\+:path\+\_\+to\+\_\+output\+\_\+file\char`\"{}}, which will create the file at the given location. You can also just use the string {\ttfamily \char`\"{}json\char`\"{}}, in which case the output can be found in the {\ttfamily test\+\_\+detail.\+json} file in the current directory.}
...
{\itshape IMPORTANT\+: The exact format of the JSON document is subject to change.}

{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md209}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_googletest_googletest_docs_advanced_autotoc_md209}
{\itshape  }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md210}{}\doxysubsubsection{Detecting Test Premature Exit}\label{md_googletest_googletest_docs_advanced_autotoc_md210}
...
{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md211}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_googletest_googletest_docs_advanced_autotoc_md211}
...
{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md212}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_googletest_googletest_docs_advanced_autotoc_md212}
...
{\itshape }\hypertarget{md_googletest_googletest_docs_advanced_autotoc_md213}{}\doxysubsection{Sanitizer Integration}\label{md_googletest_googletest_docs_advanced_autotoc_md213}
