...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily samples/sample3\+\_\+unittest.\+cc}.\hypertarget{md_googletest_googletest_docs_pkgconfig_autotoc_md244}{}\doxysubsection{CMake}\label{md_googletest_googletest_docs_pkgconfig_autotoc_md244}
...
pkg-\/config will also try to look in {\ttfamily PKG\+\_\+\+CONFIG\+\_\+\+PATH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md_googletest_googletest_docs_pkgconfig_autotoc_md246}{}\doxysubsection{Using pkg-\/config in a cross-\/compilation setting}\label{md_googletest_googletest_docs_pkgconfig_autotoc_md246}
