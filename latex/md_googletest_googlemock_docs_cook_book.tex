You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read \mbox{\hyperlink{GMockForDummies_md_googletest_googlemock_docs_for_dummies}{the dummy guide}} first to make sure you understand the basics.

{\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md36}{}\doxysection{Creating Mock Classes}\label{md_googletest_googlemock_docs_cook_book_autotoc_md36}
...
\end{DoxyItemize}\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md37}{}\doxysubsection{Dealing with unprotected commas}\label{md_googletest_googlemock_docs_cook_book_autotoc_md37}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md38}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_googletest_googlemock_docs_cook_book_autotoc_md38}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md39}{}\doxysubsection{Mocking Overloaded Methods}\label{md_googletest_googlemock_docs_cook_book_autotoc_md39}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md40}{}\doxysubsection{Mocking Class Templates}\label{md_googletest_googlemock_docs_cook_book_autotoc_md40}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_MockingNonVirtualMethods}{}\doxysubsection{Mocking Non-\/virtual Methods}\label{md_googletest_googlemock_docs_cook_book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md41}{}\doxysubsection{Mocking Free Functions}\label{md_googletest_googlemock_docs_cook_book_autotoc_md41}
...
\\\cline{1-2}
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cook_book_NiceStrictNaggy}{}\doxysubsection{The Nice, the Strict, and the Naggy}\label{md_googletest_googlemock_docs_cook_book_NiceStrictNaggy}
If a mock method has no {\ttfamily EXPECT\+\_\+\+CALL} spec but is called, we say that it\textquotesingle{}s an \char`\"{}uninteresting call\char`\"{}, and the default action (which can be specified using {\ttfamily ON\+\_\+\+CALL()}) of the method will be taken. Currently, an uninteresting call will also by default cause g\+Mock to print a warning. (In the future, we might remove this warning by default.)
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md43}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_googletest_googlemock_docs_cook_book_autotoc_md43}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_googletest_googlemock_docs_cook_book_DelegatingToFake}{}\doxysubsection{Delegating Calls to a Fake}\label{md_googletest_googlemock_docs_cook_book_DelegatingToFake}
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md46}{}\doxysection{Using Matchers}\label{md_googletest_googlemock_docs_cook_book_autotoc_md46}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md47}{}\doxysubsection{Matching Argument Values Exactly}\label{md_googletest_googlemock_docs_cook_book_autotoc_md47}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md48}{}\doxysubsection{Using Simple Matchers}\label{md_googletest_googlemock_docs_cook_book_autotoc_md48}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_CombiningMatchers}{}\doxysubsection{Combining Matchers}\label{md_googletest_googlemock_docs_cook_book_CombiningMatchers}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_SafeMatcherCast}{}\doxysubsection{Casting Matchers}\label{md_googletest_googlemock_docs_cook_book_SafeMatcherCast}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_googletest_googlemock_docs_cook_book_SelectOverload}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_googletest_googlemock_docs_cook_book_SelectOverload}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md49}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_googletest_googlemock_docs_cook_book_autotoc_md49}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md50}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_googletest_googlemock_docs_cook_book_autotoc_md50}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args$<$0, 1$>$(Truly(\&\+My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md51}{}\doxysubsection{Using Matchers as Predicates}\label{md_googletest_googlemock_docs_cook_book_autotoc_md51}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md52}{}\doxysubsection{Using Matchers in googletest Assertions}\label{md_googletest_googlemock_docs_cook_book_autotoc_md52}
Since matchers are basically predicates that also know how to describe themselves, there is a way to take advantage of them in googletest assertions. It\textquotesingle{}s called {\ttfamily ASSERT\+\_\+\+THAT} and {\ttfamily EXPECT\+\_\+\+THAT}\+:
...
The nice thing about these macros is that {\itshape they read like English}. They generate informative messages too. For example, if the first {\ttfamily EXPECT\+\_\+\+THAT()} above fails, the message will be something like\+:
...
{\bfseries{Credit\+:}} The idea of {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+THAT} was borrowed from Joe Walnes\textquotesingle{} Hamcrest project, which adds {\ttfamily assert\+That()} to JUnit.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md53}{}\doxysubsection{Using Predicates as Matchers}\label{md_googletest_googlemock_docs_cook_book_autotoc_md53}
g\+Mock provides a \href{cheat_sheet.md\#MatcherList}{\texttt{ built-\/in set}} of matchers. In case you find them lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example\+:
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in in statement {\ttfamily if (condition) ...}.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md54}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_googletest_googlemock_docs_cook_book_autotoc_md54}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md55}{}\doxysubsection{Validating a Member of an Object}\label{md_googletest_googlemock_docs_cook_book_autotoc_md55}
...
BTW, {\ttfamily Field()} and {\ttfamily Property()} can also match plain pointers to objects. For instance,
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md56}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_googletest_googlemock_docs_cook_book_autotoc_md56}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md57}{}\doxysubsection{Testing a Certain Property of an Object}\label{md_googletest_googlemock_docs_cook_book_autotoc_md57}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md58}{}\doxysubsection{Matching Containers}\label{md_googletest_googlemock_docs_cook_book_autotoc_md58}
...
\end{DoxyItemize}\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md59}{}\doxysubsection{Sharing Matchers}\label{md_googletest_googlemock_docs_cook_book_autotoc_md59}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_PureMatchers}{}\doxysubsection{Matchers must have no side-\/effects}\label{md_googletest_googlemock_docs_cook_book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md60}{}\doxysection{Setting Expectations}\label{md_googletest_googlemock_docs_cook_book_autotoc_md60}
\hypertarget{md_googletest_googlemock_docs_cook_book_UseOnCall}{}\doxysubsection{Knowing When to Expect}\label{md_googletest_googlemock_docs_cook_book_UseOnCall}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md62}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_googletest_googlemock_docs_cook_book_autotoc_md62}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md_googletest_googlemock_docs_cook_book_uninteresting-vs-unexpected}{}\doxysubsection{Understanding Uninteresting vs Unexpected Calls}\label{md_googletest_googlemock_docs_cook_book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \href{\#NiceStrictNaggy}{\texttt{ \char`\"{}\+The Nice, the Strict, and the Naggy\char`\"{}}}.\hypertarget{md_googletest_googlemock_docs_cook_book_ParameterlessExpectations}{}\doxysubsection{Ignoring Uninteresting Arguments}\label{md_googletest_googlemock_docs_cook_book_ParameterlessExpectations}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md_googletest_googlemock_docs_cook_book_PartialOrder}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_googletest_googlemock_docs_cook_book_PartialOrder}
...
g\+Mock allows you to impose an arbitrary DAG (directed acyclic graph) on the calls. One way to express the DAG is to use the \href{cheat_sheet.md\#AfterClause}{\texttt{ After}} clause of {\ttfamily EXPECT\+\_\+\+CALL}.
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md63}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_googletest_googlemock_docs_cook_book_autotoc_md63}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md64}{}\doxysection{Using Actions}\label{md_googletest_googlemock_docs_cook_book_autotoc_md64}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md65}{}\doxysubsection{Returning References from Mock Methods}\label{md_googletest_googlemock_docs_cook_book_autotoc_md65}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md66}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md_googletest_googlemock_docs_cook_book_autotoc_md66}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md67}{}\doxysubsection{Combining Actions}\label{md_googletest_googlemock_docs_cook_book_autotoc_md67}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_SaveArgVerify}{}\doxysubsection{Verifying Complex Arguments}\label{md_googletest_googlemock_docs_cook_book_SaveArgVerify}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_MockingSideEffects}{}\doxysubsection{Mocking Side Effects}\label{md_googletest_googlemock_docs_cook_book_MockingSideEffects}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md68}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_googletest_googlemock_docs_cook_book_autotoc_md68}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_googletest_googlemock_docs_cook_book_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_googletest_googlemock_docs_cook_book_DefaultValue}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md69}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_googletest_googlemock_docs_cook_book_autotoc_md69}
...
Note that both {\ttfamily ON\+\_\+\+CALL} and {\ttfamily EXPECT\+\_\+\+CALL} have the same \char`\"{}later statements take precedence\char`\"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily EXPECT\+\_\+\+CALL}s have their own precedence order distinct from the {\ttfamily ON\+\_\+\+CALL} precedence order.\hypertarget{md_googletest_googlemock_docs_cook_book_FunctionsAsActions}{}\doxysubsection{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}\label{md_googletest_googlemock_docs_cook_book_FunctionsAsActions}
...
\end{DoxyItemize}\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md70}{}\doxysubsection{Using Functions with Extra Info as Actions}\label{md_googletest_googlemock_docs_cook_book_autotoc_md70}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md71}{}\doxysubsection{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}\label{md_googletest_googlemock_docs_cook_book_autotoc_md71}
...
\end{DoxyItemize}\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md72}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_googletest_googlemock_docs_cook_book_autotoc_md72}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md73}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_googletest_googlemock_docs_cook_book_autotoc_md73}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_googletest_googlemock_docs_cook_book_SelectingArgs}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_googletest_googlemock_docs_cook_book_SelectingArgs}
...
\end{DoxyItemize}\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md74}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_googletest_googlemock_docs_cook_book_autotoc_md74}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md75}{}\doxysubsection{Sharing Actions}\label{md_googletest_googlemock_docs_cook_book_autotoc_md75}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md76}{}\doxysubsection{Testing Asynchronous Behavior}\label{md_googletest_googlemock_docs_cook_book_autotoc_md76}
...
Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md77}{}\doxysection{Misc Recipes on Using g\+Mock}\label{md_googletest_googlemock_docs_cook_book_autotoc_md77}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md78}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md_googletest_googlemock_docs_cook_book_autotoc_md78}
...
Every time this {\ttfamily EXPECT\+\_\+\+CALL} fires, a new {\ttfamily unique\+\_\+ptr$<$Buzz$>$} will be created and returned. You cannot do this with {\ttfamily Return(\+By\+Move(...))}.
...
A few actions (e.\+g. {\ttfamily Do\+All}) copy their arguments internally, so they can never work with non-\/copyable objects; you\textquotesingle{}ll have to use functors instead.\hypertarget{md_googletest_googlemock_docs_cook_book_LegacyMoveOnly}{}\doxysubsubsection{Legacy workarounds for move-\/only types}\label{md_googletest_googlemock_docs_cook_book_LegacyMoveOnly}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md79}{}\doxysubsection{Making the Compilation Faster}\label{md_googletest_googlemock_docs_cook_book_autotoc_md79}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md80}{}\doxysubsection{Forcing a Verification}\label{md_googletest_googlemock_docs_cook_book_autotoc_md80}
...
{\bfseries{Tip\+:}} The {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations()} function returns a {\ttfamily bool} to indicate whether the verification was successful ({\ttfamily true} for yes), so you can wrap that function call inside a {\ttfamily ASSERT\+\_\+\+TRUE()} if there is no point going further when the verification has failed.\hypertarget{md_googletest_googlemock_docs_cook_book_UsingCheckPoints}{}\doxysubsection{Using Check Points}\label{md_googletest_googlemock_docs_cook_book_UsingCheckPoints}
...
One such scenario is that in your test\textquotesingle{}s {\ttfamily Set\+Up()} function, you may want to put the object you are testing into a certain state, with the help from a mock object. Once in the desired state, you want to clear all expectations on the mock, such that in the {\ttfamily TEST\+\_\+F} body you can set fresh expectations on it.

As you may have figured out, the {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations()} function we saw in the previous recipe can help you here. Or, if you are using {\ttfamily ON\+\_\+\+CALL()} to set default actions on the mock object and want to clear the default actions as well, use {\ttfamily Mock\+::\+Verify\+And\+Clear(\&mock\+\_\+object)} instead. This function does what {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations(\&mock\+\_\+object)} does and returns the same {\ttfamily bool}, {\bfseries{plus}} it clears the {\ttfamily ON\+\_\+\+CALL()} statements on {\ttfamily mock\+\_\+object} too.
...
And that\textquotesingle{}s that.\hypertarget{md_googletest_googlemock_docs_cook_book_UsingThreads}{}\doxysubsection{Using g\+Mock and Threads}\label{md_googletest_googlemock_docs_cook_book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md82}{}\doxysubsection{Controlling How Much Information g\+Mock Prints}\label{md_googletest_googlemock_docs_cook_book_autotoc_md82}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md83}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md_googletest_googlemock_docs_cook_book_autotoc_md83}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md84}{}\doxysubsection{Running Tests in Emacs}\label{md_googletest_googlemock_docs_cook_book_autotoc_md84}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md85}{}\doxysection{Extending g\+Mock}\label{md_googletest_googlemock_docs_cook_book_autotoc_md85}
\hypertarget{md_googletest_googlemock_docs_cook_book_NewMatchers}{}\doxysubsection{Writing New Matchers Quickly}\label{md_googletest_googlemock_docs_cook_book_NewMatchers}
WARNING\+: g\+Mock does not guarantee when or how many times a matcher will be invoked. Therefore, all matchers must be functionally pure. See \href{\#PureMatchers}{\texttt{ this section}} for more details.
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md88}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_googletest_googlemock_docs_cook_book_autotoc_md88}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md89}{}\doxysubsection{Writing New Cardinalities}\label{md_googletest_googlemock_docs_cook_book_autotoc_md89}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_QuickNewActions}{}\doxysubsection{Writing New Actions Quickly}\label{md_googletest_googlemock_docs_cook_book_QuickNewActions}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md90}{}\doxysubsubsection{Legacy macro-\/based Actions}\label{md_googletest_googlemock_docs_cook_book_autotoc_md90}
...
\end{longtabu}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md91}{}\doxysubsubsection{Legacy macro-\/based parameterized Actions}\label{md_googletest_googlemock_docs_cook_book_autotoc_md91}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md92}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an ACTION}\label{md_googletest_googlemock_docs_cook_book_autotoc_md92}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md93}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_googletest_googlemock_docs_cook_book_autotoc_md93}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md94}{}\doxysubsection{Using the ACTION Object\textquotesingle{}s Type}\label{md_googletest_googlemock_docs_cook_book_autotoc_md94}
...
{\ttfamily ACTION\+\_\+\+TEMPLATE(Foo,}   &{\ttfamily Foo$<$t1, ..., \textbackslash{}ilinebr $<$/td$>$ $<$td class=\char`\"{}markdown\+Table\+Body\+None\char`\"{}$>$}Foo\+Action$<$t1, ...,   \\\cline{1-3}
\end{longtabu}
\+: {\ttfamily HAS\+\_\+m\+\_\+\+TEMPLATE\+\_\+\+PARAMS(...),} \+: t\+\_\+m$>$(){\ttfamily \+: t\+\_\+m$>$} \+: \+: {\ttfamily AND\+\_\+0\+\_\+\+VALUE\+\_\+\+PARAMS())} \+: \+: \+: $\vert$ {\ttfamily ACTION\+\_\+\+P(\+Bar, param)} $\vert$ {\ttfamily Bar(int\+\_\+value)} $\vert$ {\ttfamily Bar\+ActionP$<$int$>$} $\vert$ $\vert$ {\ttfamily ACTION\+\_\+\+TEMPLATE(Bar,} $\vert$ {\ttfamily Bar$<$t1, ..., t\+\_\+m$>$} $\vert$ {\ttfamily Foo\+ActionP$<$t1, ..., $\vert$ \+:}HAS\+\_\+m\+\_\+\+TEMPLATE\+\_\+\+PARAMS(...),{\ttfamily \+:}(int\+\_\+value){\ttfamily \+: t\+\_\+m, int$>$} \+: \+: {\ttfamily AND\+\_\+1\+\_\+\+VALUE\+\_\+\+PARAMS(p1))} \+: \+: \+: $\vert$ {\ttfamily ACTION\+\_\+\+P2(\+Baz, p1, p2)} $\vert$ {\ttfamily Baz(bool\+\_\+value,} $\vert$ {\ttfamily Baz\+Action\+P2$<$bool, $\vert$ \+: \+:}int\+\_\+value){\ttfamily \+: int$>$} \+: $\vert$ {\ttfamily ACTION\+\_\+\+TEMPLATE(Baz,} $\vert$ {\ttfamily Baz$<$t1, ..., t\+\_\+m$>$} $\vert$ {\ttfamily Foo\+Action\+P2$<$t1, ..., $\vert$ \+:}HAS\+\_\+m\+\_\+\+TEMPLATE\+\_\+\+PARAMS(...),{\ttfamily \+:}(bool\+\_\+value,{\ttfamily \+: t\+\_\+m,} {\ttfamily bool, int$>$} \+: \+: {\ttfamily AND\+\_\+2\+\_\+\+VALUE\+\_\+\+PARAMS(p1, p2))} \+: {\ttfamily int\+\_\+value)} \+: \+: $\vert$ ... $\vert$ ... $\vert$ ... $\vert$

Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_googletest_googlemock_docs_cook_book_NewMonoActions}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_googletest_googlemock_docs_cook_book_NewMonoActions}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_NewPolyActions}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_googletest_googlemock_docs_cook_book_NewPolyActions}
...
\end{DoxyCode}
\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md95}{}\doxysubsection{Teaching g\+Mock How to Print Your Values}\label{md_googletest_googlemock_docs_cook_book_autotoc_md95}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily $<$$<$} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{../../googletest/docs/advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ googletest\textquotesingle{}s advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_googletest_googlemock_docs_cook_book_autotoc_md96}{}\doxysection{Useful Mocks Created Using g\+Mock}\label{md_googletest_googlemock_docs_cook_book_autotoc_md96}
\hypertarget{md_googletest_googlemock_docs_cook_book_MockFunction}{}\doxysubsection{Mock std\+::function}\label{md_googletest_googlemock_docs_cook_book_MockFunction}
